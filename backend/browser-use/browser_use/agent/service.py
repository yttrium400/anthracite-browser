...
class Agent(Generic[Context, AgentStructuredOutput]):
	...
	async def get_model_output(self, input_messages: list[BaseMessage], llm: BaseChatModel | None = None) -> AgentOutput:
		...
		try:
			response = await llm.ainvoke(input_messages, **kwargs)
