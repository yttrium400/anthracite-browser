...
// YouTube ad scrubbing is handled by CDP Fetch interception in AdBlockService.ts
// (Content script injection doesn't work: YouTube CSP blocks inline scripts,
//  and webFrame.executeJavaScript runs in isolated world with contextIsolation)
